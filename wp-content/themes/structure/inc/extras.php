...
function ThemeMove_comment( $comment, $args, $depth ) {
	...
	<div id="comment-<?php comment_ID(); ?>">
		...
		<div class="comment-content">
			...
			<?php endif; ?>
			<div class="metadata">
				<?php printf( esc_html__( '<cite class="fn">%s</cite>', 'thememove' ), get_comment_author_link() ) ?> <br/>
				<a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>">
					<?php printf( esc_html__( '%1$s', 'thememove' ), get_comment_date(), get_comment_time() ) ?></a>
				<?php edit_comment_link( esc_html__( '(Edit)', 'thememove' ), '  ', '' ) ?>
			</div>
			<?php comment_text() ?>
...
function new_projects_fields( $fields ) {
	$fields['default_template'] = array(
		'name'        => esc_html__( 'Use Default Template', 'thememove' ),
		'description' => esc_html__( 'Check this option if you want to use default template for this project.', 'thememove' ),
		'type'        => 'checkbox',
		'value'       => 'yes',
		'section'     => 'info'
	);
	...
	$fields['location'] = array(
		'name'        => esc_html__( 'Location', 'thememove' ),
		'description' => esc_html__( 'Enter a location for this project.', 'thememove' ),
		'type'        => 'text',
		'default'     => '',
		'section'     => 'info'
	);
	...
	$fields['surface_area'] = array(
		'name'        => esc_html__( 'Surface Area', 'thememove' ),
		'description' => esc_html__( 'Enter a surface area for this project.', 'thememove' ),
		'type'        => 'text',
		'default'     => '',
		'section'     => 'info'
	);
	...
	$fields['year_completed'] = array(
		'name'        => esc_html__( 'Year Completed', 'thememove' ),
		'description' => esc_html__( 'Enter a year Completed for this project.', 'thememove' ),
		'type'        => 'text',
		'default'     => '',
		'section'     => 'info'
	);
	...
	$fields['value'] = array(
		'name'        => esc_html__( 'Value', 'thememove' ),
		'description' => esc_html__( 'Enter a value for this project.', 'thememove' ),
		'type'        => 'text',
		'default'     => '',
		'section'     => 'info'
	);
	...
	$fields['architect'] = array(
		'name'        => esc_html__( 'Architect', 'thememove' ),
		'description' => esc_html__( 'Enter a architect for this project.', 'thememove' ),
		'type'        => 'text',
		'default'     => '',
		'section'     => 'info'
	);
...
function job_department( $fields ) {
	$fields['_job_department'] = array(
		'label'       => esc_html__( 'Department', 'thememove' ),
		'type'        => 'text',
		'placeholder' => '',
		'description' => ''
	);
